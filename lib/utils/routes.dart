...
import 'package:world_wanders/services/trip_service.dart';
import 'package:world_wanders/services/user_service.dart';
import 'package:world_wanders/ui/forms/create_trip_form.dart';
...
import 'package:world_wanders/ui/forms/nearby_search_form.dart';
...
class Routes {
  static Map<String, Widget Function(BuildContext)> routes = {
    ...
    RouteConstants.TRIP_NEW: (context)
      => ChangeNotifierProvider<CreateTripProvider>(
        create: (context) => CreateTripProvider(TripService()),
